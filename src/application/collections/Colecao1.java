...
public class Colecao1 {
    public static void main(String[] args) {
        //Conjunto de elementos únicos, sem organização dos elementos.
        ...
        Set<Integer> conjuntoB = new HashSet<>(Set.of(1,2,5,6,7,10,19,21,18,4,0));
        ...
        Set<Integer> remocao = new HashSet<>(conjuntoA);
