...
public class Colecao3 {
    public static void main(String[] args) {
        //Conjunto de elementos únicos, organizado na ordem de inserção dos elementos.

        //Declaração
        Set<Integer> conjuntoA = new LinkedHashSet<>();
        ...
        Set<Integer> conjuntoB = new LinkedHashSet<>(Set.of(1,2,5,6,7,10,19,21,18,4,0));

        System.out.println("União dos conjuntos A e B: ");

        Set<Integer> uniao = new LinkedHashSet<>();
